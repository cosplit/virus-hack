function [results, num_split, num_tests] = strategy_double_check(samples,tester,test_param)
%Runs the Dounle Check strategy on the samples while using the tester which
...
[res_a, num_split_a, num_tests_a] = strategy_double_check(samples(1:mid_idx,results_temp),tester,test_param);
[res_b, num_split_b, num_tests_b] = strategy_double_check(samples(mid_idx+1:end,results_temp),tester,test_param);
